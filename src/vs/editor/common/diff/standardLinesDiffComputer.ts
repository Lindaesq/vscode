...
import { findMaxBy } from 'vs/base/common/arrays';
...
import { ILinesDiffComputer, ILinesDiffComputerOptions, LineRangeMapping, LinesDiff, MovedText, RangeMapping } from 'vs/editor/common/diff/linesDiffComputer';
	...
	computeDiff(originalLines: string[], modifiedLines: string[], options: ILinesDiffComputerOptions): LinesDiff {
		...
		for (const deletion of deletions) {
			...
			if (highestSimilarity > 0.90 && best) {
				...
				moves.push(new MovedText(deletion.range, best.range, mappings));
			}
		}
